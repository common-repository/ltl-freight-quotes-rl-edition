...
if (!class_exists("EnWDQuotesRL")) {
    ...
    class EnWDQuotesRL
    {
        ...
        {
            add_filter('en_wd_update_query_string_rl', array($this, 'en_wd_update_query_string_rl'), 10, 1);
            add_filter('en_wd_origin_array_set_rl', array($this, 'en_wd_origin_array_set_rl'), 10, 1);
            add_filter('en_wd_standard_plans_rl', array($this, 'en_wd_standard_plans_rl'), 10, 4);
        ...
        public function en_wd_standard_plans_rl($post_data, $destination_zip, $origin_array, $package_plugin)
        {
            $action = $this->check_package_plan($package_plugin);
            if ($action) {
                return $post_data;
         ...
         * @return string
         */
        public function en_wd_update_query_string_rl()
        {
            // Terminal phone number
            return " ,phone_instore, enable_store_pickup , fee_local_delivery , suppress_local_delivery , miles_store_pickup , match_postal_store_pickup , checkout_desc_store_pickup , enable_local_delivery , miles_local_delivery , match_postal_local_delivery , checkout_desc_local_delivery, origin_markup";
        }
         ...
         * @return array type
         */
        public function en_wd_origin_array_set_rl($origin)
        {
            ...
            $origin_markup = (isset($origin->origin_markup)) ? $origin->origin_markup : "";
            ...
            return array(
                ...
                'sender_origin' => $location . ": " . $city . ", " . $state . " " . $zip,
