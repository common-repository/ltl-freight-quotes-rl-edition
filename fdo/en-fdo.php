...
class EnRLfreightFdo
{
    ...
    public function en_cart_package($package)
    {
        ...
        $this->en_fdo_meta_data['plugin_name'] = 'rnl_quotes';
        $accessorials['residential'] = get_option('wc_settings_rnl_residential') == 'yes' ? true : false;
        $accessorials['liftgate'] = get_option('wc_settings_rnl_liftgate') == 'yes' ? true : false;
