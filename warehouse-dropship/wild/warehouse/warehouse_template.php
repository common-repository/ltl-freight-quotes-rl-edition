...
<script type="text/javascript">
    ...
    function en_wd_add_warehouse_btn()
    {
        ...
        jQuery("#en_wd_origin_markup").val('');
    ...
    function rl_ltl_change_warehouse_zip()
    {
        if (jQuery("#en_wd_origin_zip").val() == '') {
            return false;
        }

        jQuery('#en_wd_origin_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-rl-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-rl-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('.city_select_css').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-rl-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-rl-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');

        var postForm = {
            'action': 'rl_ltl_en_wd_get_address',
            ...
            <div class="content" style="overflow-y: scroll; height: 500px;">
                ...
                <form method="post" id="add_warehouses">
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" title="Zip"  maxlength="7" onchange="rl_ltl_change_warehouse_zip()" value="" name="en_wd_origin_zip" placeholder="30214" id="en_wd_origin_zip">
                        <span class="en_wd_err"></span>
                    </div>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        <label for="en_wd_origin_markup">Handling Fee / Markup</label>
                ...
                -->
                    <div class="heading">
                        <label class="heading_left">
                            <h2 class="warehouse_heading">In-store pick up</h2>
                        </label>
                        <div class="pickup-delivery-checkboxes">
                            <a href="#">
                                <h2 class="warehouse_heading pakage_notify_instore_warehouse"><?php echo $package_required; ?></h2>
                            </a>
                        </div>
                    </div>
                ...
                -->
                    ...
                    <div class="heading">
                        <label class="heading_left">
                            <h2 class="local-delivery-heading">Local Delivery</h2>
                        </label>
                        <div class="pickup-delivery-checkboxes">
                            <a href="#">
                                <h2 class="local-delivery-heading pakage_notify_local_warehouse"><?php echo $package_required; ?></h2>
                            </a>
                        </div>
                    </div>
                ...
                -->
                    <div class="form-btns">
                    <input type="submit" name="en_wd_submit_warehouse" value="Save" class="save_warehouse_form" onclick="return rl_ltl_en_wd_save_warehouse();">
                    </div>
                </form>
            </div>
        </div>
