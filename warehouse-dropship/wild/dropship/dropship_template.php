...
<script type="text/javascript">
    ...
    function hide_drop_val()
    {
        ...
        jQuery("#en_wd_dropship_markup").val('');
    ...
    function change_dropship_zip()
    {
        ...
        jQuery('#en_wd_dropship_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-rl-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-rl-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        ...
        jQuery('#en_wd_dropship_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo plugins_url(); ?>/ltl-freight-quotes-rl-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        ...
        <div class="en_wd_add_warehouse_popup ds_popup">
            ...
            <div class="content">
                ...
                <form method="post" id="add_dropships">
                    ...
                    <div class="en_wd_add_warehouse_input">
                        <label for="en_wd_dropship_markup">Handling Fee / Markup</label>
                        <input type="text" class="numericonly" maxlength="8"  title="Handling Fee / Markup" name="en_wd_dropship_markup"
                               data-optional="1" value="" placeholder="e.g Currency 1.00 or percentage 5%" id="en_wd_dropship_markup">
                    </div>
                ...
                -->
                    <div class="heading">
                        ...
                        <div class="pickup-delivery-checkboxes">
                            <a href="#">
                                <h2 class="warehouse_heading pakage_notify_instore_dropship"><?php echo $package_required; ?></h2>
                            </a>
                        </div>
                    </div>
                ...
                -->
                    ...
                    <div class="heading">
                        ...
                        <div class="pickup-delivery-checkboxes">
                            <a href="#">
                                <h2 class="local-delivery-heading pakage_notify_local_dropship"><?php echo $package_required; ?></h2>
                            </a>
                        </div>
                    </div>
