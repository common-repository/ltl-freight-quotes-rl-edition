...
if (!class_exists("RlLtlEnWooWdAddonsAjaxReqIncludes")) {

    class RlLtlEnWooWdAddonsAjaxReqIncludes
    {
        ...
        {
            add_action('wp_ajax_nopriv_rl_ltl_en_wd_get_address', array($this, 'get_address_api_ajax'));
            add_action('wp_ajax_rl_ltl_en_wd_get_address', array($this, 'get_address_api_ajax'));
            ...
            add_action('wp_ajax_nopriv_rl_ltl_en_wd_save_warehouse', array($this, 'save_warehouse_ajax'));
            add_action('wp_ajax_rl_ltl_en_wd_save_warehouse', array($this, 'save_warehouse_ajax'));
        ...
        function get_address_api_ajax()
        {
            if (isset($_POST['origin_zip'])) {
                ...
                $accessLevel = 'address';
                $Get_yrc_quotes_distance = new Get_rnl_quotes_distance();
                $resp_json = $Get_yrc_quotes_distance->rnl_quotes_get_distance($zipCode, $accessLevel);
...
new RlLtlEnWooWdAddonsAjaxReqIncludes();