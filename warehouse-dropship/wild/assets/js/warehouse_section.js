jQuery(document).ready(function () {
    ...
    // Origin terminal address
    // Terminal phone number
    jQuery("#en-phone-number, #en_wd_dropship_nickname, #en_wd_dropship_address, #en_wd_dropship_zip, #en_wd_dropship_city, #en_wd_dropship_state, #en_wd_dropship_country, #instore-pickup-address, #instore-pickup-desc, #local-delivery-address, #local-delivery-desc, #local-delivery-fee").focus(function (e) {
 ...
 * @returns {Boolean}
 */
if (typeof rl_ltl_en_wd_save_warehouse != 'function') {
    function rl_ltl_en_wd_save_warehouse() {
        ...
        var postForm = {
            'action': 'rl_ltl_en_wd_save_warehouse',
            ...
            'origin_markup': jQuery('#en_wd_origin_markup').val(),
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('.dropship_created').css('display', 'none');
                    window.location.href = jQuery('.close').attr('href');
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_warehouse_list_data">' + data.origin_city + '</td><td class="en_wd_warehouse_list_data">' + data.origin_state + '</td><td class="en_wd_warehouse_list_data">' + data.origin_zip + '</td><td class="en_wd_warehouse_list_data">' + data.origin_country + '</td><td class="en_wd_warehouse_list_data"><a href="javascript(0)" title="Edit" onclick="return en_wd_edit_warehouse(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-rl-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_warehouse(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-rl-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
                } else {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                if (data[0]) {
                    ...
                    jQuery('#en_wd_origin_markup').val(data[0].origin_markup);
...
if (typeof en_wd_save_dropship != 'function') {
    function en_wd_save_dropship() {
        ...
        var postForm = {
            ...
            'origin_markup': jQuery('#en_wd_dropship_markup').val(),
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('.warehouse_created').css('display', 'none');
                    window.location.href = jQuery('.close').attr('href');
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_dropship_list_data">' + data.nickname + '</td><td class="en_wd_dropship_list_data">' + data.origin_city + '</td><td class="en_wd_dropship_list_data">' + data.origin_state + '</td><td class="en_wd_dropship_list_data">' + data.origin_zip + '</td><td class="en_wd_dropship_list_data">' + data.origin_country + '</td><td class="en_wd_dropship_list_data"><a href="javascript(0)" title="Edit" onclick="return en_wd_edit_dropship(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-rl-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_dropship(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/ltl-freight-quotes-rl-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
                } else {
                    jQuery('.already_exist').show('slow');
                    jQuery('.content').delay(200).animate({scrollTop: 0}, 300);
                    setTimeout(function () {
        ...
        jQuery.ajax({
            ...
            success: function (data) {
                if (data[0]) {
                    ...
                    jQuery('#en_wd_dropship_markup').val(data[0].origin_markup);
                    jQuery('.en_wd_zip_validation_err').hide();
                    jQuery('.en_wd_city_validation_err').hide();
                    jQuery('.en_wd_state_validation_err').hide();
                    jQuery('.en_wd_country_validation_err').hide();
